...
public class Pokemon implements Serializable {
    ...
    public Pokemon(int idPokemon, String name, String element, String evoname, int exp, int maxexp, int lv, int hp, int maxhp, int def, int att, String gambar, int idSkill1, int idSkill2, int idSkill3, int idSkill4) {
